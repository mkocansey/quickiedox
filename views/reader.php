...
?>
    <body>
            ...
            <div class="max-w-8xl mx-auto flex">
                <div class="basis-1/3">
                    <a href="<?php echo docs_home() ?>">
                        <img src="/assets/images/logo.svg" alt="QuickDox Logo" class="h-10 pb-1" />
                    </a>
                </div>
                <div class="relative basis-1/3">
                    <input type="text" placeholder="Quick Search" onkeyup="search(this.value)" 
                        class="absolute w-full border border-primary-200/70 dark:border-slate-900 rounded-full py-2 px-9 focus:outline-none focus:shadow-inner focus:ring-2 focus:ring-primary-500 dark:ring-gray-600 text-primary-600 dark:text-primary-300 mt-[-1px] dark:bg-white/5 search placeholder:dark:opacity-50" />
                ...
                <div class="text-right flex items-center flex-row-reverse gap-3 basis-1/3">
                    <a href="#" class="inline-block p-1.5 rounded-md bg-primary-300/30 dark:bg-slate-800 dark:text-primary-100 text-primary-600 hover:bg-primary-400 hover:text-primary-100 dark:opacity-80 dark:hover:opacity-100">
        ...
        <div class="max-w-8xl mx-auto px-4 flex">
            <div class="lg:!block z-40 inset-0 top-[82px] w-[17.5rem] pb-10 pt-6 overflow-y-auto border-r border-slate-100 dark:border-slate-800/70 fixed left-[max(0px,calc(50%-45rem))] right-auto px-4">
